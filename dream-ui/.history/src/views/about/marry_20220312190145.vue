 ...
 * @LastEditTime: 2022-03-12 19:01:45
-->
<script>
...
export default {
  ...
  data() {
    return {
      ...
      { url: 'https://cloud-image', isImage: true },{ url: 'https://cloud-image', isImage: true },{ url: 'https://cloud-image', isImage: true },{ url: 'https://cloud-image', isImage: true },{ url: 'https://cloud-image', isImage: true },{ url: 'https://cloud-image', isImage: true },{ url: 'https://cloud-image', isImage: true },],
    };
  },
  methods: {
    onSubmit() {},
  ...
  <van-form @submit="onSubmit">
    <van-cell-group inset>
      ...
      <van-field
        ...
        @click="showArea = true"
      />
      <van-uploader label="文件上传" multiple :max-count="9" :after-read="afterRead" v-model="photos"/>
