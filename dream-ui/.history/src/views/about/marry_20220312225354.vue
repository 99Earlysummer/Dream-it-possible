 ...
 * @LastEditTime: 2022-03-12 22:53:21
-->
<script>
...
<template>
  <van-form @submit="onSubmit">
    ...
    <div style="margin:20px;padding:10px">
      <van-button round block class="mr-20" type="primary" size="normal" native-type="submit">保存</van-button>
      <van-button round block class="mr-20" type="primary" size="normal">预览</van-button>
    </div>
  </van-form>
</template>
<style scoped>
