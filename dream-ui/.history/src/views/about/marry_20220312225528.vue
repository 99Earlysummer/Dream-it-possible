 ...
 * @LastEditTime: 2022-03-12 22:55:06
-->
<script>
...
<template>
  <van-form @submit="onSubmit">
    ...
    <div style="margin:20px;padding:10px">
      <van-button    type="primary" size="normal" native-type="submit">保存</van-button>
      <van-button    type="primary" size="normal">预览</van-button>
      <van-button   class="mr-20" type="primary" size="normal">预览</van-button>
    </div>
  </van-form>
</template>
<style scoped>
