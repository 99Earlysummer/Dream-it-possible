 ...
 * @LastEditTime: 2022-03-12 23:04:14
-->
<script>
...
<template>
  <van-form @submit="onSubmit">
    ...
    <van-cell-group style="text-algin:center;margin:0 auto">
      <van-button style="text-algin:center;margin:0 auto" type="primary" native-type="submit">保存</van-button>
      <van-button style="text-algin:center;margin:0 auto" type="primary">预览</van-button>
      <van-button style="text-algin:center;margin:0 auto" type="primary">预览</van-button>
    </van-cell-group>
  </van-form>
</template>
