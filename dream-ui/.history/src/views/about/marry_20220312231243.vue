 ...
 * @LastEditTime: 2022-03-12 23:12:43
-->
<script>
...
<template>
  <div>
    ...
    <van-cell-group title="基本信息">
      ...
      <van-button block class="mb-`2`0" type="primary" native-type="submit">保存</van-button>
      <van-button block class="mb-20" type="primary">预览</van-button>
