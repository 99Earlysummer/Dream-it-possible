 ...
 * @LastEditTime: 2022-03-12 23:54:54
-->
<script>
...
export default {
  ...
  methods: {
    ...
    onConfirm() {},
    onConfirmBirth(data){
      let dataStr=let delayTime = new Date(data).toJSON().split('T')[0];
      this.form.birth=this.parseTime(data,"yyyy-MM-dd");
...
<template>
  <div>
    ...
    <van-cell-group title="基本信息">
      ...
      />
      <van-calendar v-model:show="showCalendar" @confirm="onConfirmBirth" />
      ...
      <van-button block class="mb-10" type="primary" @click="onSubmit">保存</van-button>
