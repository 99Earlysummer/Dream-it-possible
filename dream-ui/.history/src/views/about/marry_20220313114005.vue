 ...
 * @LastEditTime: 2022-03-13 11:39:53
-->
<script>
...
export default {
  ...
  data() {
    return {
      ...
      regionList: areaList,
      minDate:'1990-01-01',
      maxDate:new Date(2010, 1, 21).getTime(),
      form: {
        name: "",
        sex: "1",
        birth: "",
...
<template>
  <div>
    ...
    <van-cell-group title="基本信息">
      ...
      />
      <van-calendar :min-date="minDate" :max-date="maxDate" v-model:show="showCalendar" @confirm="onConfirmBirth" />
