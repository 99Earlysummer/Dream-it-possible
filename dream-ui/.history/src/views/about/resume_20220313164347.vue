 ...
 * @LastEditTime: 2022-03-13 16:43:43
-->
<script>
    ...
    initDetail(uuid) {
      ...
      ResumeApi.getDetail(uuid).then((response) => {
        if (response.code == 0) {
          ...
          _this.form.xingZhuo = _this.birthToConstellation(_this.form.birth);
          _this.form.shengXiao = _this.birthToShengxiao(_this.form.birth);
        }
      });
    },
    onSubmit() {
