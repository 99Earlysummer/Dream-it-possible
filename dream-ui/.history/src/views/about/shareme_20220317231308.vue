 ...
 * @LastEditTime: 2022-03-17 23:13:07
-->
<script>
import { ResumeApi } from "@/api/blog";
import { Form, Cell, CellGroup, Button, Divider, Swipe, SwipeItem } from "vant";
export default {
  components: {
    [Button.name]: Button,
    [Form.name]: Form,
...
<template>
  <div class="loader-section">
    <van-swipe style="height: 100vh; color: orange" vertical :loop="false" indicator-color="orange
    ">
      <van-swipe-item>
        <van-cell-group>
          <div class="profile-thumb" style="background: url(~@/assets/image/profile.jpg);"></div>
        </van-cell-group>
         <van-swipe-item>
...
@font-face {
  ...
  url(~@/assets/fonts/my-custom-icon-font.svg#my-custom-icon-font) format('svg');
  font-weight: normal;
  font-style: normal;
}
