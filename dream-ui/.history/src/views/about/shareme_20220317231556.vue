 ...
 * @LastEditTime: 2022-03-17 23:15:48
-->
<script>
import { ResumeApi } from "@/api/blog";
import { Form, Cell, CellGroup, Button, Divider, Swipe, SwipeItem ,Image as VanImage} from "vant";
export default {
  components: {
    [Button.name]: Button,
    [Form.name]: Form,
    ...
    <van-swipe
      ...
      <van-swipe-item>
        <van-cell-group>
          ...
          <div
            class="profile-thumb"
            style="background: url(~@/assets/image/profile.jpg)"
          ></div>
        </van-cell-group>
      </van-swipe-item>
      <van-swipe-item>
