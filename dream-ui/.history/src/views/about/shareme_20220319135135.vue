 ...
 * @LastEditTime: 2022-03-19 13:50:39
-->
<script>
    ...
    >
      ...
      <van-swipe-item>
        <van-cell-group title="基本信息">
          ...
          <van-cell title="姓名" :value="form.sex == 0 ? '男' : '女'" />
          <van-cell title="姓名" :value="form.birth" />
          <van-cell title="姓名" :value="form.shengXiao" />
          <van-cell title="姓名" :value="form.xingZhuo" />
          <van-cell title="姓名" :value="form.height" />
          <van-cell title="姓名" :value="form.weight" />
          <van-cell title="姓名" :value="form.regionVal" />
          <van-cell title="姓名" :value="form.school" />
          <van-cell title="姓名" :value="form.company" />
        </van-cell-group>
      </van-swipe-item>
      <van-swipe-item>
