 ...
 * @LastEditTime: 2022-03-19 16:47:20
-->
<script>
    ...
    >
      ...
      <van-swipe-item>
        ...
        <van-cell-group title="生活照片">
          <ul>
            <li class="vphoto"><van-image width="10em" height="10em" src="https://img.yzcdn.cn/vant/cat.jpeg" /></li>
            <li class="vphoto"><van-image width="50" height="100" src="https://img.yzcdn.cn/vant/cat.jpeg" /></li>
            <li class="vphoto"><van-image width="50" height="100" src="https://img.yzcdn.cn/vant/cat.jpeg" /></li>
            <li class="vphoto"><van-image width="50" height="100" src="https://img.yzcdn.cn/vant/cat.jpeg" /></li>
          </ul>
