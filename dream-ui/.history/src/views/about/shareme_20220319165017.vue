 ...
 * @LastEditTime: 2022-03-19 16:50:05
-->
<script>
    ...
    >
      <van-swipe-item>
       ...
       <van-cell-group title="基本信息">
          ...
          <van-cell title="身高" :value="form.height" />
          <van-cell title="体重" :value="form.weight" />
      ...
      <van-swipe-item>
        ...
        <van-cell-group title="生活照片">
          <ul>
            <li class="vphoto"><van-image @click="phClick" width="6em" height="6em" src="https://img.yzcdn.cn/vant/cat.jpeg" /></li>
            <li class="vphoto"><van-image width="6em" height="6em" src="https://img.yzcdn.cn/vant/cat.jpeg" /></li>
            <li class="vphoto"><van-image width="6em" height="6em" src="https://img.yzcdn.cn/vant/cat.jpeg" /></li>
            <li class="vphoto"><van-image width="6em" height="6em" src="https://img.yzcdn.cn/vant/cat.jpeg" /></li>
          </ul>
            <van-image-preview :images="photos"/>
        </van-cell-group>
      </van-swipe-item>
      <van-swipe-item>
