 ...
 * @LastEditTime: 2022-03-19 16:58:33
-->
<script>
      ...
      <van-swipe-item>
        ...
        <van-cell-group title="生活照片">
          <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
                <van-swipe-item v-for="(m,index) in photos">
                  <img :src="m"/>
                </van-swipe-item>
               <template #indicator="{ active, photos.length }">
              <div class="custom-indicator">{{ active + 1 }}/{{ photos.length }}</div>
            </template>
          </van-swipe>
